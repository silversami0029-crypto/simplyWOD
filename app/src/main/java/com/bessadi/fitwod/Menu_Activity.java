...
import java.util.List;
    ...
    private void testBillingSafely() {
        ...
        new Thread(() -> {
            try {
                ...
                PremiumManager testManager = new PremiumManager(Menu_Activity.this);
                ...
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(Menu_Activity.this, "Billing test passed!", Toast.LENGTH_SHORT).show();
                });
                ...
                runOnUiThread(() -> {
                    dismissLoadingDialog();
                    Toast.makeText(Menu_Activity.this, "Billing error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
            }
        }).start();
    }
 ...
 private void loadAdView (){
    ...
    {
        startActivity(new Intent(Menu_Activity.this, Menu_Activity.class));
    }
...
private void forPremiumUser(){
    ...
    {
        Toast.makeText(Menu_Activity.this, "Open Video: " ,Toast.LENGTH_SHORT).show();
    }
