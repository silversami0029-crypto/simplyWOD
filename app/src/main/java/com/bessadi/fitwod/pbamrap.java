...
public class pbamrap extends AppCompatActivity {
    ...
    long preTimeLeft =11000;
    private String voiceNote = null;
    ImageButton addBtn, resetBtn, playBtn, goback,recordVoice;
    TextView timeLeftTv, roundCounter;
    CountDownTimer timeCountDown = null, pre_timeCountDown = null, timeCountDown_amrap = null;
    private ConstraintLayout mainLayout_amrap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pbamrap);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                // For example, show a confirmation dialog or perform a custom action
        ...
        mainLayout_amrap = findViewById(R.id.main_layout_amrap);
        /*adv request detail*/
       ...
       // mAdView.loadAd(adRequest);
        ...
        addBtn = findViewById(R.id.btnAdd_amrap);
        resetBtn = findViewById(R.id.ib_reset_amrap);
        goback = findViewById(R.id.ib_back_amrap);
        playBtn = findViewById(R.id.ibPlay_amrap);
        roundCounter = findViewById(R.id.tvcounterButton_amrap);
        //Audio variables
        mplayer = MediaPlayer.create(pbamrap.this, R.raw.let_go);
        wellDonePlayer = MediaPlayer.create(pbamrap.this, R.raw.welldone);
        singlebeepplayer = MediaPlayer.create(pbamrap.this, R.raw.singlebeep1);
        lastround = MediaPlayer.create(pbamrap.this, R.raw.lastround);
        recordVoice = findViewById(R.id.btnRecordVoice_amrap);
            ...
            Glide.with(this)
                    ...
                    .into(new CustomTarget<Drawable>() {
                        ...
                        public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                            mainLayout_amrap.setBackground(resource);
                        }
    ...
    private void setDefaultBackground(int drawableResourceId) {
        mainLayout_amrap.setBackgroundResource(drawableResourceId);
    }

    private void setTimeFunction() {
        Dialog timeDialog = new Dialog(this);
        timeDialog.setContentView(R.layout.add_amrap_dialog);
        EditText roundSet = timeDialog.findViewById(R.id.etGetMinutes_amrap);
        TextView timeLeftTv = findViewById(R.id.tvTimeLeft_amrap);
        TextView roundDisplay = findViewById(R.id.tvrounds_amrap);
        ProgressBar progressBar_amrap = findViewById(R.id.pbTimer_amrap);

        timeDialog.findViewById(R.id.btnGo_amrap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (roundSet.getText().toString().isEmpty()) {
                    // Toast.makeText(pbamrap.this, "Please enter For Time duration", Toast.LENGTH_SHORT).show();
                    alertdialog("AMRAP","Please enter AMRAP duration");
                } else {
                    ...
                    progressBar_amrap.setMax(maxtime);
                    //saveToDb();
    ...
    private void goback_to_mainMenu() {
        ...
        startActivity(new Intent(pbamrap.this, Menu_Activity.class));
    }

    private void resetTime() {
        if (timeCountDown_amrap != null) {
            timeCountDown_amrap.cancel();
            roundSelected = 0;
            timeSelected = 0;
            pauseOffSet = 0;
            timeProgress = 0;
            timeCountDown_amrap = null;
            isTimerRunning = false;
            minutes = 0;
            seconds = 0;
            playBtnEnabled();
            ProgressBar progressBar_amrap = findViewById(R.id.pbTimer_amrap);
            progressBar_amrap.setProgress(0);
            progressBar_amrap.setProgressDrawable(ContextCompat.getDrawable(this, R.drawable.blue1_progressbar_background));
            TextView timeLeftTv = findViewById(R.id.tvTimeLeft_amrap);
    ...
    public void startTimer(long timeLeftInMillis) {
        ...
        ProgressBar progressBar_amrap = findViewById(R.id.pbTimer_amrap);
        progressBar_amrap.setProgress(timeProgress);
        progressBar_amrap.setProgressDrawable(ContextCompat.getDrawable(this, R.drawable.blue1_progressbar_background));
        timeSelected = roundSelected * 60; // convert to seconds
        timeCountDown_amrap = new CountDownTimer((timeSelected * 1000), 1000) {
            @Override
            public void onTick(long p0) {
                timeProgress++;
                progressBar_amrap.setProgress(timeSelected - timeProgress); // already converted to seconds timeSelected = roundSelected * 60;
                TextView timeLeftTv = findViewById(R.id.tvTimeLeft_amrap);
                TextView roundDisplay = findViewById(R.id.tvrounds_amrap);
            ...
            public void onFinish() {
                ...
                TextView roundDisplay = findViewById(R.id.tvrounds_amrap);
                playWellDone();
                alertdialog("AMRAP","Time's up: WELL DONE!!");// display dialog to a user
                saveToDb();
                resetTime();
            }
        }.start();
    ...
    public void preStartTimer() {
        playBtnDisabled();
        Toast.makeText(pbamrap.this, "Workout starts in 10 seconds ", Toast.LENGTH_SHORT).show();
        preTimeRunning = true;
    ...
    public void checkInput() {
        if (roundSelected > timeProgress) {
            ...
            alertdialog("AMRAP","Please add AMRAP duration");
        }
    ...
    private void startRecording() {
        ...
        try {
            ...
            String fileName = "AMRAP_VOICE_" + timeStamp + ".3gp";
    ...
    private void saveToDb() {
        WorkoutDbHelper dbHelper = new WorkoutDbHelper(pbamrap.this);
        ...
        try {
            ...
            if (id != -1) {
                ...
                Toast.makeText(pbamrap.this, "Saved successfully with ID: " + id, Toast.LENGTH_SHORT).show();
